...
# modul load anacondapy/5.3.1 #you can remove this line if you are working in your own conda environment
...
project_dir=/jukebox/graziano/sarah/judge_attention
